...
//         {/* LinkedIn */}
//         <a
//           href="https://www.linkedin.com/in/saisanthoshmv/"
//           target="_blank"
...
//         {/* GitHub */}
//         <a
//           href="https://github.com/saisanthoshmv"
//           target="_blank"
//           rel="noopener noreferrer"
//         >
//           <DockIcon className="bg-black/10 dark:bg-white/10">
...
//         {/* Mail */}
//         <a href="mailto:mvs.sai999@gmail.com">
//           <DockIcon className="bg-black/10 dark:bg-white/10">
  ...
  return (
    <div className="relative">
      <Dock iconMagnification={60} iconDistance={100}>
        ...
        <DockIcon className="bg-black/10 dark:bg-white/10">
            {/* GitHub */}
            <a  href="https://github.com/saisanthoshmv"
                target="_blank"
                rel="noopener noreferrer"
            >
                <Icons.gitHub className="size-full" />
